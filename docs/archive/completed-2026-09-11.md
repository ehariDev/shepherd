# Completed work through v0.5.0 — the ledger's history

> Moved out of `docs/project-status.md` on 2026-09-11 when the v0.5.0 release closed every item
> below. This is the record of **why things are the way they are**; it is not maintained and must
> not be read as current instructions. The live ledger keeps only what is still open. The
> user-facing view of the same period is `CHANGELOG.md` (v0.0.1 → v0.5.0).
>
> Sections are verbatim from the ledger as it stood at `e75234f`, in the order they appeared
> there, with their original dates. Commit SHAs cited inside them resolve in this repository
> (its history starts at `b83d5d99`, 2026-08-18).

## Dated passes (ledger §1 history)
...
Opened from the 2026-09-09 review (`docs/archive/reviews/2026-09-09-remediation.md`), seven parallel
...
### F9-a — `ssh` auth kind fails in the compose stack · **FIXED 2026-09-10; e2e gate green 2026-09-11**
...
## Features closed (ledger §3 history)
...
## Follow-ups closed (ledger §4 history)
